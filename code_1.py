...
df_points = pd.merge(pd.merge(df_points.merge(df_bowlers.to_frame(), left_index=True, right_index=True), df_fielding, left_index=True, right_index=True, how='left'), df_man_of_match, left_index=True, right_index=True, how='outer')
...
#Top Batsman Based on the stadium venue - name of the stadium
